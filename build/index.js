...
exports.setActiveTransaction = setActiveTransaction;
var FETCH_TRANSACTIONS = exports.FETCH_TRANSACTIONS = 'FETCH_TRANSACTIONS';
var RECEIVE_TRANSACTIONS = exports.RECEIVE_TRANSACTIONS = 'RECEIVE_TRANSACTIONS';

var SET_ADDRESS = exports.SET_ADDRESS = 'SET_ADDRESS';

var SET_ACTIVE_TRANSACTION_ID = exports.SET_ACTIVE_TRANSACTION_ID = 'SET_ACTIVE_TRANSACTION_ID';
...
function fetchTransactions(address) {
  return function (dispatch) {
    ...
    return fetch('https://bitaps.com/api/address/transactions/' + address).then(function (response) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(16);
...
var _TransactionsList = __webpack_require__(27);
...
var BitcoinHistoryOuter = function (_Component) {
  _inherits(BitcoinHistoryOuter, _Component);

  function BitcoinHistoryOuter(props) {
    _classCallCheck(this, BitcoinHistoryOuter);

    return _possibleConstructorReturn(this, (BitcoinHistoryOuter.__proto__ || Object.getPrototypeOf(BitcoinHistoryOuter)).call(this, props));
  }

  _createClass(BitcoinHistoryOuter, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'bitcoin-history' },
        !this.props.address ? _react2.default.createElement(_Form2.default, null) : null,
        _react2.default.createElement(_TransactionsList2.default, null)
      );
    }
  }]);

  return BitcoinHistoryOuter;
}(_react.Component);

exports.default = (0, _reactRedux.connect)(null, { setAddress: _actions.setAddress, fetchTransactions: _actions.fetchTransactions })(BitcoinHistoryOuter);
...
var _TransactionsReducer = __webpack_require__(31);

var _TransactionsReducer2 = _interopRequireDefault(_TransactionsReducer);

var _BitcoinAddressReducer = __webpack_require__(29);

var _BitcoinAddressReducer2 = _interopRequireDefault(_BitcoinAddressReducer);

var _LoadingReducer = __webpack_require__(30);

var _LoadingReducer2 = _interopRequireDefault(_LoadingReducer);

var _ActiveTransactionReducer = __webpack_require__(66);

var _ActiveTransactionReducer2 = _interopRequireDefault(_ActiveTransactionReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({
  transactions: _TransactionsReducer2.default,
  btcAddress: _BitcoinAddressReducer2.default,
  loading: _LoadingReducer2.default,
  activeTransactionId: _ActiveTransactionReducer2.default
});
...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    _this.onSetAddressClicked = _this.onSetAddressClicked.bind(_this);
    return _this;
  }
  ...
  _createClass(Form, [{
    ...
    key: 'onSetAddressClicked',
    value: function onSetAddressClicked(e) {
      e.preventDefault();
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'btc-form-wrap' },
        _react2.default.createElement(
          'div',
          { className: 'btc-address-wrap' },
          ...
          _react2.default.createElement(
            'span',
            { className: 'btc-address-set' },
            _react2.default.createElement(
              'a',
              { href: '#', onClick: this.onSetAddressClicked },
              'load'
            )
          )
        )
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, {
  ...
  fetchTransactions: _actions.fetchTransactions
})(Form);
...
var _TransactionInfo = __webpack_require__(67);

var _TransactionInfo2 = _interopRequireDefault(_TransactionInfo);
...
var TransactionListItem = function TransactionListItem(_ref) {
  ...
  var dateString = date.getFullYear() + '-' + pad(date.getMonth()) + '-' + pad(date.getDate()) + ' ' + pad(date.getHours()) + ':' + pad(date.getMinutes()) + ':' + pad(date.getSeconds());
  var info = active ? _react2.default.createElement(_TransactionInfo2.default, { transaction: transaction }) : null;
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(
...
var _TransactionListItem = __webpack_require__(26);

var _TransactionListItem2 = _interopRequireDefault(_TransactionListItem);
...
var TransasctionsList = function (_Component) {
  _inherits(TransasctionsList, _Component);

  function TransasctionsList() {
    _classCallCheck(this, TransasctionsList);

    return _possibleConstructorReturn(this, (TransasctionsList.__proto__ || Object.getPrototypeOf(TransasctionsList)).apply(this, arguments));
  }
        ...
        return _react2.default.createElement(
          'li',
          {
            ...
            onClick: function onClick() {
              return _this2.props.setActiveTransaction(t.hash);
            }
          },
          _react2.default.createElement(_TransactionListItem2.default, { transaction: t, active: active })
        );
      });
    }
  }, {
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { setActiveTransaction: _actions.setActiveTransaction })(TransasctionsList);
...
var _BitcoinHistoryOuter2 = _interopRequireDefault(_BitcoinHistoryOuter);
...
var BitcoinHistory = function (_React$Component) {
  _inherits(BitcoinHistory, _React$Component);

  function BitcoinHistory() {
    _classCallCheck(this, BitcoinHistory);

    return _possibleConstructorReturn(this, (BitcoinHistory.__proto__ || Object.getPrototypeOf(BitcoinHistory)).apply(this, arguments));
  }

  _createClass(BitcoinHistory, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        _reactRedux.Provider,
        { store: store },
        _react2.default.createElement(_BitcoinHistoryOuter2.default, this.props)
      );
    }
  }]);
...
exports.default = BitcoinHistory;
...
var INITIAL_STATE = '1EzwoHtiXB4iFwedPr49iywjZn2nnekhoj';
...
exports.default = function () {
  ...
  switch (action.type) {
    case _actions.FETCH_TRANSACTIONS:
      return true;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(20), __webpack_require__(65)(module)))
...
exports.default = function () {
  ...
  switch (action.type) {
    case _actions.SET_ACTIVE_TRANSACTION_ID:
...
var TransasctionInfo = function TransasctionInfo(_ref) {
  var transaction = _ref.transaction;
  ...
  return _react2.default.createElement(
    "div",
    { className: "transaction-additional-info" },
    _react2.default.createElement(
      "div",
      { className: "info-item" },
      _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "div",
        { className: "value cap status-" + status },
        status
      )
    ),
    _react2.default.createElement(
